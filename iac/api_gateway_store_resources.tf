...
resource "aws_api_gateway_method" "stores_get_method" {
  rest_api_id   = aws_api_gateway_resource.stores_resource.rest_api_id
  resource_id   = aws_api_gateway_resource.stores_resource.id
  http_method   = "GET"
  authorization = "CUSTOM"
...
resource "aws_api_gateway_method" "store_put_method" {
  rest_api_id   = aws_api_gateway_resource.workspace_resource.rest_api_id
  resource_id   = aws_api_gateway_resource.workspace_resource.id
  http_method   = "PUT"
  authorization = "CUSTOM"
...
resource "aws_api_gateway_integration" "store_put_integration" {
  http_method             = aws_api_gateway_method.store_put_method.http_method
  resource_id             = aws_api_gateway_resource.workspace_resource.id
  rest_api_id             = aws_api_gateway_rest_api.stores_api_gateway.id
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_integration" "stores_get_integration" {
  http_method             = aws_api_gateway_method.stores_get_method.http_method
  resource_id             = aws_api_gateway_resource.stores_resource.id
  rest_api_id             = aws_api_gateway_rest_api.stores_api_gateway.id
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
